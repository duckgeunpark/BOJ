...
2026년 3월 18일 16:51:39

### 문제 설명

<p style="user-select: auto !important;">
	정수 n(0 ≤ n ≤ 4*10<sup style="user-select: auto !important;">9</sup>)가 주어졌을 때, n보다 크거나 같은 소수 중 가장 작은 소수 찾는 프로그램을 작성하시오.</p>
